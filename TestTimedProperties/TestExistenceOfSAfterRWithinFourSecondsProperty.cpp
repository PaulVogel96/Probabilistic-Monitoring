...
testF(TestExistenceOfSAfterRWithinFourSecondsProperty, Property_switches_from_satisfied_to_violated_and_back) {
  //given
  ExistenceOfSAfterRWithinFourSecondsProperty automaton;
  ...
  //when 
  std::vector<uint8_t> events2 = {EVENT_R, EVENT_N};
  std::vector<uint32_t> timestamps2 = {5000, 10000};
  ...
  //when
  std::vector<uint8_t> events3 = {EVENT_R, EVENT_S};
  std::vector<uint32_t> timestamps3 = {11000, 12000};
