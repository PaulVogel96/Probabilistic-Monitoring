...
#include <Utils.hpp>
#include <traces/proportional_missing/seed2025/coupled_proportional_missing_seed2025_iid_mr_0_05.hpp>
...
void loop() {
  if (events_processed < 3603) {
    uint8_t event = pgm_read_byte(&coupled_proportional_missing_seed2025_iid_mr_0_05[events_processed]);
