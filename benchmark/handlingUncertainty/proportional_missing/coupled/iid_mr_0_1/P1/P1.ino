...
#include <Utils.hpp>
#include <traces/proportional_missing/coupled_proportional_missing_iid_mr_0_1.hpp>
...
void loop() {
  if (events_processed < 3603) {
    uint8_t event = pgm_read_byte(&coupled_proportional_missing_iid_mr_0_1[events_processed]);
