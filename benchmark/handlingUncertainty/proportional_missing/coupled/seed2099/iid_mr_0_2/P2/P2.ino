...
#include <Utils.hpp>
#include <traces/proportional_missing/seed2099/coupled_proportional_missing_seed2099_iid_mr_0_2.hpp>
...
void loop() {
  if (events_processed < 3603) {
    uint8_t event = pgm_read_byte(&coupled_proportional_missing_seed2099_iid_mr_0_2[events_processed]);
