...
#include <Utils.hpp>
#include <traces/periodic_missing/seed2025/coupled_periodic_missing_seed2025_T10_keep0_5.hpp>
...
void loop() {
  if (events_processed < 3603) {
    uint8_t event = pgm_read_byte(&coupled_periodic_missing_seed2025_T10_keep0_5[events_processed]);
