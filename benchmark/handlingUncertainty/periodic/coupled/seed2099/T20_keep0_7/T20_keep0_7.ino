...
#include <Utils.hpp>
#include <traces/periodic_missing/seed2099/coupled_periodic_missing_seed2099_T20_keep0_7.hpp>
...
void loop() {
  if (events_processed < 3603) {
    uint8_t event = pgm_read_byte(&coupled_periodic_missing_seed2099_T20_keep0_7[events_processed]);
