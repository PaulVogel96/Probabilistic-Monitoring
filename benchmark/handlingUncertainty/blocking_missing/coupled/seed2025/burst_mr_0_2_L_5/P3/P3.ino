...
#include <Utils.hpp>
#include <traces/blocking_missing/seed2025/coupled_blocking_missing_seed2025_mr0_2_L_5.hpp>
...
void loop() {
  if (events_processed < 3603) {
    uint8_t event = pgm_read_byte(&coupled_blocking_missing_seed2025_mr0_2_L_5[events_processed]);
