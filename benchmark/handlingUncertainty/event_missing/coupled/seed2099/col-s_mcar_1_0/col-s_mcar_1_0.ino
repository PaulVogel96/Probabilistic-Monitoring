...
#include <Utils.hpp>
#include <traces/event_missing/seed2099/coupled_event_missing_seed2099_col-s_mcar1_0.hpp>
...
void loop() {
  if (events_processed < 3603) {
    uint8_t event = pgm_read_byte(&coupled_event_missing_seed2099_col_s_mcar1_0[events_processed]);
